describe('Handbook', () => {
    it('Set the language to english', () => {
        cy.login();
        cy.visit('https://localhost/settings/user');
    ...
    it('Set the theme to white', () => {
        cy.login();
        cy.visit('https://localhost/settings/user/theming');
        cy.get('.theming__preview--light .checkbox-radio-switch__icon').click();
    });

    it('Reset the account', () => {
        cy.login();
        cy.visit('https://localhost/apps/passwords/#/settings');
    ...
    it('Capture New Password Dialog', () => {
        ...
        cy.login();
        cy.visit('https://localhost/apps/passwords/#/all');
    ...
    it('Capture Folder Section', () => {
        cy.login();
        cy.visit('https://localhost/apps/passwords/#/folders');
    ...
    it('Capture Favourites Section', () => {
        cy.login();
        cy.visit('https://localhost/apps/passwords/#/favorites');
        cy.get('div.row');
    ...
    it('Capture Shared Section', () => {
        cy.login();
        cy.visit('https://localhost/apps/passwords/#/shared');
        cy.get('div.row');
    ...
    it('Capture Security Section', () => {
        cy.login();
        cy.visit('https://localhost/apps/passwords/#/security');
        cy.get('div.row');
    ...
    it('Capture Handbook Section', () => {
        cy.login();
        cy.visit('https://localhost/apps/passwords/#/help');
        cy.get('h1#help-top');
    ...
    it('Capture Tags Section', () => {
        cy.login();
        cy.visit('https://localhost/apps/passwords/#/tags');
    ...
    it('Capture Settings Section', () => {
        ...
        cy.wait(500);
        cy.get('.settings-level .checkbox-radio-switch__icon').click();
        cy.get('section.security h1').scrollIntoView({offset: {top: -60}});
    ...
    it('Capture Export Section', () => {
        cy.login();
        cy.visit('https://localhost/apps/passwords/#/backup/export');
    ...
    it('Capture Password Sidebar', () => {
        ...
        cy.get('.modal-container .disable-warning').click();
        cy.get('.modal-container').screenshotWithPreview('password-qrcode', {padding: 10});
    });
});