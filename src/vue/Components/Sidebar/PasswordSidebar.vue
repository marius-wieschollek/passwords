...
<template>
    ...
    >
        ...
        <template #tertiary-actions>
            ...
            <nc-button class="password-details-favorite" :aria-label="t(password.favorite ? 'Remove from favorites':'Mark as favorite')" variant="tertiary" @click.prevent="actions.favorite()">
