...
/**
 * @TODO      Remove this file in 2019.1.0
 *
...
class CompareVersion {
     ...
     * @return mixed
     */
    private function compareMajorMinor(
        string $actual,
        string $required,
        string $comparator
    ) {
...
namespace OCA\Passwords\Compatibility;
 ...
 */
class CompareVersion extends \OC\App\CompareVersion {
