(function() {
    let translations = {
            ...
            'Importing passwords'                 : 'Bezig met importeren wachtworden',
            ...
            'Password Generator'                  : 'Wachtword generator',
            'Password strength'                   : 'Wachtword sterkte',
            'Include numbers'                     : 'Nummers gebruiken',
            'Include special characters'          : 'Bijzondere karakters gebruiken',
            'User Interface'                      : 'Gebruikersinterface',
            'Initial section'                     : 'Initieel bereik',
            'All Passwords'                       : 'Alle wachtwoorden',
            'Passwords List View'                 : 'Wachtwoorden in lijst overzicht',
            'Set title from'                      : 'Dit veld als titel gebruikenDieses Feld als Titel verwenden',
            'Sort by'                             : 'Sorteer op',
            'Title field'                         : 'Titelveld',
            'Single click action'                 : 'Atie bij klik',
            'Double click action'                 : 'Aktie bij dubbelklik',
            ...
            'Security issues'                     : 'Beveiligings issues',
            'Passwords shared with me'            : 'Met mij gedeelde wachtwoorden',
            'Show Notifications for'              : 'Laat berichtgevingen zien voor',
            ...
            'Deleted items will appear here'      : 'Verwijderde items zullen hier verschijnen',
        ...
        helpTexts    = {
            ...
            'Action to perform when clicking on a password in the list view'             : 'Aktie die die bij een klik op het Wachtwoord wordt uitgevoerd',
            'Action to perform when double clicking on a password in the list view'      : 'Aktie die bij een dubbelklik op een wachtwoord wordt uitgevoerd',
            ...
            'Sends you e-mails about compromised passwords and other security issues'    : 'Stuurt u E-Mails wanneer wachtwoorden gecompromiteerd zijn of wanneer er andere beveiligingsroblemen optreden',
            ...
            'You have to wait {seconds} seconds before you can reset your account.'      : 'U dient {seconds} seconden te wachten voordat uw gebruikersaccont gereset kan worden.',
