(function() {
    let translations = {
            ...
            'Delete'                              : 'Effacer',
            'Restore'                             : 'Restaurer',
            'New Password'                        : 'Nouveau mots de passe',
            ...
            'Creating tag failed'                 : 'L’étiquette n’a pas pu être effacé',
            'Edit tag'                            : 'Modifier l’étiquette',
            'Tag saved'                           : 'Étiquette sauvée',
            'Saving tag failed'                   : 'L’étiquette n’a pas pu être sauvé',
            'Delete tag'                          : 'Effacer l’étiquette',
            'Do you want to delete the tag'       : 'Êtes vous sur de vouloir effacer l’étiquette ?',
            'Tag deleted'                         : 'Étiquette effacée',
            'Deleting tag failed'                 : 'L’étiquette n’a pas pu être effacée',
            'Tag restored'                        : 'L’étiquette restaurée',
            ...
            'Password saved'                      : 'Mot de passe sauvé',
            'Saving password failed'              : 'Le mot de passe n’a pas pu être sauvé',
            ...
            '{element} was copied to clipboard'   : '{element} ont été copiés dans le presse-papier',
            ...
            'Do you want to restore the revision?': 'Êtes vous sur de vouloir restaurer une version antérieure ?',
            ...
            'Open Office Calc'                    : 'Open/Libre Office Calc',
            'Backup password'                     : 'Restaurer L’application',
            ...
            'Export passwords shared with me'     : 'Exporter les mots de passe partagé avec moi',
            'Don\'t edit passwords shared with me': 'Ne pas éditer les mots de passe partagé avec moi',
            ...
            'Space'                               : 'Espace',
            'Tab'                                 : 'Tabulation',
            'Detect unescaped quotes'             : 'Détecté les apostrophes non échappés',
            ...
            'Failed to decrypt passwords'         : 'Déchiffrement des mots de passé échoué',
            ...
            'Restore all items in trash?'         : 'Restaurer les éléments à leurs emplacement initiaux',
            ...
            'Passwords List View'                 : 'Réglage liste des mots de passe',
            ...
            'Copy password'                       : 'Copier le mots de passe',
            ...
            'Show hidden custom fields'           : 'Montrer les champs cachés',
            ...
            'Show Notifications for'              : 'Montrer un notification pour',
            ...
            'Missing something or found an error?': 'Il vous manque une fonctionnalité ou vous rencontrée un bogue ?',
        ...
        helpTexts    = {
            ...
            'Mark passwords as weak if they surpass the specified amount of days'        : 'Marque les mots de passe comme "Faible" quand ils dépassent une durée limite spécifié en jours',
            ...
            'Notifies you when a background operation fails'                             : 'Envoie une notification quand un tache en arrière plan échoue',
            ...
            'Start over and delete all configuration, passwords, folders and tags'       : 'Restaurer les paramètres d’usine et supprimer tous les mots de passe, dossiers et tags',
            'You have reached the maximum length of 4096 characters'                     : 'Vous avez atteint la longueur maximale de 4096 caractères',
            'Invalid trailing quote in quoted field'                                     : 'Le caractère de champ est masqué de manière incorrecte',
            'We could not find anything for "{query}"'                                   : 'Rien n’à été trouvé pour la recherche "{query}"',
            'The file could not be parsed: {errors}'                                     : 'Le fichier n’a pas pu être traité',
